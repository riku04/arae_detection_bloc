class Constants {
  ...
  static const String USER_SETTING_DATABASE_NAME = "user_settings_42.db";
  static const String DEFAULT_USER_SETTING_TABLE = "user_settings_42";
  static const int ALPHA_MASK = 0x20000000;
  static const int SCAN_TIMEOUT = 30;
