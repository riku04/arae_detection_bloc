...
class MapBloc extends Bloc{
  ...
  PolygonLayerOptions _draftPolygonLayer;
  PolygonLayerOptions _polygonLayer;
  PolygonLayerOptions _expandedPolygonLayer;
  PolygonLayerOptions _moreExpandedPolygonLayer;
  ...
  void initLayers(){
    ...
    _markerLayer = MarkerLayerOptions(
